...
if __name__=='__main__':
    ...
    for indx in range(len(fragments)):
        smi = smiles[0][indx]
        w = Chem.SDWriter('/data/localhost/not-backed-up/scratch/vost/temp/frag.sdf')
        w.write(fragments[indx])
        w.close()

        arguments.output_directory = '/data/localhost/not-backed-up/scratch/vost/output/output%s'%indx
        arguments.fragment_sdf = '/data/localhost/not-backed-up/scratch/vost/temp/frag.sdf'
